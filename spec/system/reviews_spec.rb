...
RSpec.describe "Reviews", type: :system do
  ...
  # let(:review) { create(:review, store_id: 1, user_id: 2, reviews_title: "その他", score: 4, store_price: 1000, instrument_name: "Horn", store_reviews: "test", store: [store]) }
  # let(:review2) { create(:review, user_id: 2, store: [store]) }
